...
description: Planificación del Sprint 0 - Fase de Cimientos y Prototipado del proyecto EmprendeX.
---

## 🟢 Sprint 0: Fase de Cimientos y Prototipado

### Objetivo del Sprint

> Establecer los cimientos del proyecto: definir la arquitectura técnica y funcional, configurar las herramientas de gestión del equipo, diseñar los prototipos iniciales de la interfaz y preparar el entorno de desarrollo base para el inicio del MVP.
